				...
				<fieldset>
					...
					<table>
						...
						<tr>
							...
							<td>
						  	<input type="checkbox" name="anycategory">any&nbsp;category
								<input type="checkbox" name="nocategories">no&nbsp;categories<br/>
								
									<input type="checkbox" name="nv/lib/bod"/>nv/lib/bod
								
									<input type="checkbox" name="nv/obj/dat"/>nv/obj/dat
								
									<input type="checkbox" name="nv/sys"/>nv/sys
