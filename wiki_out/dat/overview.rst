...
command level user interface known as `PG <./com/pg/index.html>`_,
...
interface called `GRIM <./gr/index.html>`_ (GRaphical Interface to oMinas).
...
routines referred to as `PG <./com/pg/index.html>`_.

The graphical interface to OMINAS is called `GRIM <./gr/index.html>`_.
...
fancy TVIM, GRIM may be used on its own.
    ...
    <div class="footer">
      ...
      <table class="smaller" summary="footer">
        <tr>
          <td class="left">Produced by IDLdoc 3.6.1 on Tue Oct 11 05:39:17 2016</td>
