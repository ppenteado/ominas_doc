...
*/
title = "OMINAS APII Documentation";
...
libdata[libdataItem++] = new Array("./dat_header_value.html", "dat_header_value.pro", '.pro file in <a href="./dir-overview.html">./ directory</a>', "dat_header_value.pro", "", "", "", "", "          -1", "");
  ...
  libdata[libdataItem++] = new Array("./dat_header_value.html#dat_header_value", "dat_header_value", 'routine in <a href="./dat_header_value.html">dat_header_value.pro</a>', "dat_header_value.pro", "", "dat_header_value", "	Reads and write header keyword values.    ", "getValue of the specified keyword read from the header.     setNew value to write to the specified keyword.    noeventdd	Data descriptor.   keywordString giving the name of the keyword to get or set.   ", "NV/SYS", " 	Written by:	Spitale, 8/2013  	Adapted by:	Spitale, 5/2016   ");
...
libdata[libdataItem++] = new Array("./dat_redo.html", "dat_redo.pro", '.pro file in <a href="./dir-overview.html">./ directory</a>', "dat_redo.pro", "", "", "", "", "          -1", "");
  
  
  libdata[libdataItem++] = new Array("./dat_redo.html#dat_redo", "dat_redo", 'routine in <a href="./dat_redo.html">dat_redo.pro</a>', "dat_redo.pro", "", "dat_redo", "	Decrements the data archive index in the data descriptor.    ", "noeventddData descriptor.   ", "NV/OBJ/DAT", " 	Written by:	Spitale  	Adapted by:	Spitale, 7/2016   ");
