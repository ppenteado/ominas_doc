...
idldoc,root=getenv('OMINAS_DIR')+'/docs_src/',output=outdir,title='OMINAS Documentation',$
...
replaceoverview,outdir+'user_guide.html','./ug.html',outdir+'user_guide.old'
replaceindex,outdir+'userguide.html','user_guide.html',outdir+'empty.html',outdir+'toc.html'
if ~file_test('newheader/guides/images',/directory) then file_copy,'./images','./newheader/guides',/verbose,/recursive
