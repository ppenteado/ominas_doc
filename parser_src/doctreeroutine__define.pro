...
pro doctreeroutine::setProperty, name=name, $
  ...
  if (n_elements(commheader) gt 0) then begin
    self.commheader=ptr_new(commheader)
  endif
...
function doctreeroutine::getVariable, name, found=found
  ...
  case strlowcase(name) of
    ...
    'plain_attributes': begin
      ...
      'has_commheader' : begin
          return,ptr_valid(self.commheader)
       end
      'commheader': begin
          return,*self.commheader
        end
